...
export function MoreFiltersSheet({
  ...
  const [localFilters, setLocalFilters] = useState<Partial<ReviewFilters>>(filters);
  const { data: supportedModels, isLoading: modelsLoading } = useSupportedModels();
      ...
      <SheetContent className="w-full sm:max-w-md">
        ...
        <div className="flex flex-col gap-6 sm:gap-8 max-h-[calc(100vh-200px)] p-4">
          <div className="space-y-2.5">
            <Label htmlFor="provider" className="text-xs sm:text-sm font-semibold">
              Provider
            </Label>
            <Select
          ...
          <div className="space-y-2.5">
            ...
            >
              <SelectTrigger id="model" className="h-10 sm:h-11">
                <SelectValue placeholder={modelsLoading ? "Loading models..." : "All models"} />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-4 sm:space-y-5">
            <div className="space-y-2.5">
              <Label htmlFor="start-date" className="text-xs sm:text-sm font-semibold">
                Start Date
              </Label>
            ...
            <div className="space-y-2.5">
              <Label htmlFor="end-date" className="text-xs sm:text-sm font-semibold">
                End Date
              </Label>
              <div className="relative">
                <Input
        ...
        <SheetFooter className="flex flex-col sm:flex-row gap-3 pt-6 mt-auto">
          ...
          <SheetClose asChild>
            <Button onClick={handleApply} className="w-full sm:flex-1" size="default">
              Apply Filters
            </Button>
          </SheetClose>
        </SheetFooter>
